...
// Mock products data for a specific subsubcategory
const mockProducts = Array.from({ length: 24 }, (_, i) => ({
  id: (i + 200).toString(),
  name: `Men's Shirt Product ${i + 1}`,
  ...
  image: `/Image/User/tshirt.jpeg?height=300&width=400`,
  category: "Clothing",
...
export default function SubsubcategoryPage({
  ...
  const subcategoryName = "Men's Clothing"
  const subsubcategoryName = "Shirts"
  const description = "Shop our collection of high-quality men's shirts for every occasion"
  ...
  const filterGroups: FilterGroup[] = [
    ...
    },
    {
      ...
      type: "checkbox",
      options: [
        { id: "cotton", name: "Cotton", count: 56 },
        { id: "polyester", name: "Polyester", count: 42 },
        { id: "linen", name: "Linen", count: 28 },
        { id: "silk", name: "Silk", count: 18 },
        { id: "wool", name: "Wool", count: 12 },
      ],
    },
    {
      id: "sleeve",
      ...
      type: "checkbox",
      options: [
        { id: "short", name: "Short Sleeve", count: 48 },
        { id: "long", name: "Long Sleeve", count: 36 },
        { id: "sleeveless", name: "Sleeveless", count: 24 },
      ],
    },
    {
      id: "fit",
      ...
      type: "checkbox",
      options: [
        { id: "slim", name: "Slim Fit", count: 42 },
        { id: "regular", name: "Regular Fit", count: 36 },
        { id: "relaxed", name: "Relaxed Fit", count: 24 },
  ...
  }, [products, activeFilters, activeSort, searchTerm])
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="flex items-center text-sm text-muted-foreground mb-6">
        ...
        <span className="mx-2">/</span>
        <Link href={`/category/${params.slug}`} className="hover:text-primary">
          {categoryName}
        </Link>
        <span className="mx-2">/</span>
        <Link href={`/category/${params.slug}/${params.subslug}`} className="hover:text-primary">
          {subcategoryName}
        </Link>
        <span className="mx-2">/</span>
        <span className="text-foreground font-medium">{subsubcategoryName}</span>
      </div>

      {/* Subcategory Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold">{subsubcategoryName}</h1>
        ...
        <div className="mt-4 md:mt-0 w-full md:w-auto">
          <SearchBar
            ...
            placeholder={`Search in ${subsubcategoryName}...`}
                        ...
                        <div className="flex items-center mb-2">
                          <div className="flex">
                            {[1, 2, 3, 4, 5].map((star) => (
                              <Star
                                key={star}
                                className={`h-3 w-3 ${star <= Math.round(product.rating!)
